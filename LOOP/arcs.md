...
| S3 | Parallel: Poisson W G0 / PARK SE doors | **done (SIGNED PARK)** | — | **PARK SE doors** signed 2026-08-17; tape unchanged; KEEP/REPLACE not invented. |
...
| C1 | Melissa reconcile + after-task + handover refresh | **doing** | — | Sign ledger + G2 non-draft docs PR. |
...
**HARD STOPS:** no undraft #1077 · no real `confint(method="profile")` · no public `se=TRUE` · no Design 118/B1/Totoro · no Arc 1A reopen · no invent Poisson W KEEP/REPLACE (PARK is signed)
