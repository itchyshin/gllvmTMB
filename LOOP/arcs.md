...
| S3 | Parallel: Poisson W G0 / PARK SE doors note | **todo** (card **UNSIGNED**) | **OPEN if inventing SIGNED** | Card remains **UNSIGNED** (`70b8d874`). Silent default PARK further SE doors; Gate 1 PARK paste keeps card UNSIGNED. Do **not** invent SIGNED. |
