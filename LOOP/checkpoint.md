...
STATE: S1 Design **125** claimed (`b68b20b4`); S2 ADEMP draft; S4 Rose fence **PASS** (one research-note wording fix); next = S3 then V1.
ARCS DONE (verified):
...
- S1 — Design stub `docs/design/125-mspl-profile-led-intervals.md`; claimed by commit `b68b20b4`.
...
NEXT: **S3** (Poisson W UNSIGNED / PARK SE doors note); then V1.
...
- Design 125 scope soft (binary-first) — Ada default in Design 125 §3.1; confirm or widen only at signed G0
...
- Pre-reg `docs/dev-log/research/2026-08-17-mspl-profile-led-prereg-ademp.md`
...
```text
You are mspl-profile-led-ci — Design 125 + ADEMP pre-reg drafted under D-157. RESUME.
...
BRANCH: claude/lane-mspl-profile-led-ci
CONTINUE FROM: S3 (Poisson W UNSIGNED note). S4 Rose fence done. Pre-reg cites Design 125 @ b68b20b4.
