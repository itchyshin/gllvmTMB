...
#' }
#'
#' For `nbinom2`, the dispersion \eqn{\hat\phi} is itself subject to the known
#' dispersion / latent-variance identifiability confound (see `families()` and
#' the response-families article); the derived \eqn{\sigma^2_d}, and any
#' covariance built from it, inherit that attenuation and should be read as
#' recovery-only.
#'
