...
#' intervals, selection, cross-platform verification,
...
#' separate bounded contracts. `bootstrap_temporal()` and `profile_temporal()`
#' also support the qualified replicated AR1
