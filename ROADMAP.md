...
| **M2** | **Binary completeness** | 🟢 In progress | `███░░░░░` 3/7 | Weeks 3–5. M2.1 design note + M2.2-A binary family recovery + M2.2-B binary CIs/extractors + glmmTMB cross-check shipped 2026-05-17; `lambda_constraint` binary IRT next. |
