...
| package check | separate check suite | 20–25 min | 30 min | 1 | PASS1311.453s;0E/0W/1N |
...
Package receipt complete: R CMD check0 errors/0 warnings/1 NOTE (unchanged-source logLik import). Testthat0 failures/54 warnings/1190 skips/16067 passes. No package rerun. Final candidate CI has its own post-push receipt and is not scientific validation.
