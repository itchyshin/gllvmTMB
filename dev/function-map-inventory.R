...
function_map_inventory <- list(
  list(
    id = "prepare", label = "1. Prepare and specify", colour = "#3D7A57",
  ...
  list(
    id = "fit", label = "2. Fit", colour = "#2D6FA3",
  ...
  list(
    id = "check", label = "3. Check fit health", colour = "#9367A6",
  ...
  list(
    id = "interpret", label = "4. Interpret covariance", colour = "#B06C31",
  ...
  list(
    id = "uncertainty", label = "5. Choose a target-specific uncertainty route", colour = "#A64E5F",
  ...
  list(
    id = "report", label = "6. Report, predict, or simulate", colour = "#167C7C",
