...
The implementation must also retain the conditional-mode/inner optimization status, Hessian availability and conditioning diagnostics, plus an independently recomputed endpoint objective. These are diagnostics, not new acceptance criteria.
