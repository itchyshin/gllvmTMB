...
| S3c | Terra-high + Curie; 2-4 days | Temporal plus animal pair | S2 | **In progress:** replicated AR1 `temporal_indep()` plus fixed in-keyword `animal_indep()` has independent additive dense/product-control, `A`/pedigree/sparse-`Ainv` provenance, label-permutation, long/wide, update, and simulation tests. Recovery remains unrun. |
