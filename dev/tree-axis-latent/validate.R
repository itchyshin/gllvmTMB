...
if (length(argv) && identical(argv[[1L]], "--coefficient")) {
  source(file.path(dirname(script_path), "validate-coefficient.R"))
  quit(status = if (isTRUE(coefficient_ledger$pass)) 0L else 1L)
}
