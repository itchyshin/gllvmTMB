...
evidence. Other compositions require canonical links, admit rank 1 through the
number of logical responses, and may use either the ordinary automatic `Psi`
companion or `unique = FALSE`. Repeated-family traits are admitted. A verified
