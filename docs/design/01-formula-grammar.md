...
Automatic `Psi` is admitted only when its rotation-adjusted loading parameters
plus engine-free diagonal parameters do not exceed the available covariance
moments. Repeated-family traits are admitted. A verified
