...
| MIS-22 | Morphometrics cached bootstrap correlation fixture | `covered` | `test-example-morphometrics.R` | Ships `inst/extdata/examples/morphometrics-bootstrap-r.rds` for article rendering and visual QA of `plot_correlations(bootstrap_Sigma, style = "raindrop")`; the fixture is not interval-calibration evidence. |
