...
**Status:** Phase 2 written 2026-08-15 · **STOP at G0 — awaiting Shinichi approval.**  
Do **not** start Phase 3 in this planning thread. After G0, execute via `/goal` in a **fresh** chat.
