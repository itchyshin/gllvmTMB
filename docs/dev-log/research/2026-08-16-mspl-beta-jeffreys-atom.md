...
**Date:** 2026-08-16
**Lane:** `cursor/mspl-beta-jeffreys-atom-fix`
...
1. **Wrong GLM-outer diagonal.** From the Beta log-likelihood,
   \(I_\mu=\phi^2\{\psi'(a)+\psi'(b)\}\) and
   \(I_\eta=I_\mu\{\mu(1-\mu)\}^2\). Ferrari & Cribari-Neto (2004)
   write that as \(K_{\beta\beta}=\phi X^\top W X\) with inner
   \(w_t=\phi\{\psi'(a)+\psi'(b)\}/\{g'(\mu)\}^2\). On logit the
