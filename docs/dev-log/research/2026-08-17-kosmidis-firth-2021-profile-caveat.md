...
- **`#1075`'s "profile = signature / primary claim path" MSPL footnote is landed** in
  `docs/dev-log/research/2026-08-17-mspl-ci-wald-plus-profile.md` (this sitting’s docs
  reconcile). D-12's profile-over-Wald doctrine stands in general and for ML; what does not
