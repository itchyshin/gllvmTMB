...
- hold-out-nT | T1-anchor-n40-T8 | seed 20260830 | n_rep=200 | avail=1.0000 | refuse=0.0000 | cov_ret=0.9400 (MCSE 0.0168) Wilson [0.8981, 0.9653] | cov_eff=0.9400 (MCSE 0.0168) Wilson [0.8981, 0.9653] | n_ret/n_ref/n_cov=200/0/188 | T1-RECORDED | tstar=NOT-FROZEN
