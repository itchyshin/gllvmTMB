# Arc ledger — Paper 2 iJSDM evidence-to-reader
...
| --- | --- | --- | --- |
| 0. Rehydrate and lock | closed | `GOAL.md`, A0 reconciliation | Exact G2o base; private Codex-only lane; all three protected HOLDs. |
